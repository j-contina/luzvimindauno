<?php // Sub-Admin Register ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Subadmin Register</title>
...
<body style="background: url('../assets/cover.jpg') no-repeat center center fixed; background-size: cover; position: relative; min-height: 100vh;">
    ...
    <div class="register-container">
        <img src="../assets/logoo.png" alt="Logo" class="register-logo">
        <div class="register-title">Sub-Admin Registration</div>
        <div class="register-subtitle">Create a Department Manager Account</div>
        ...
        <div class="form-text mt-3">
            Already have an account? <a href="login.php">Login as Sub-Admin</a>
        </div>
    </div>
    <style>
        .bg-blur {
