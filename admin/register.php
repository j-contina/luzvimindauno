...
<head>
    ...
    <title>Admin Registration | Barangay Luzviminda Uno</title>
...
<body style="background: url('../assets/cover.jpg') no-repeat center center fixed; background-size: cover; position: relative; min-height: 100vh;">
    ...
    <div class="register-container">
        ...
        <div class="register-subtitle">Create a System Administrator Account</div>
        ...
        <div class="form-text mt-3">
            Already have an account? <a href="login.php">Login as Admin</a>
        </div>
    </div>
    <style>
        .bg-blur {
